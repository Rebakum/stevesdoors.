import heroImg from "@/assets/images/Gallery/Image-gallery-ext-int.jpg";
  ...
  return (
    <section className="container mx-auto py-12">
      <div className=" flex flex-col-reverse md:flex-row-reverse items-center px-6 md:px-12 gap-8">
        {/* Text Content */}
        <div className="w-full text-left h-[500px] rounded-sm flex flex-col justify-center items-start  p-20 bg-gray-300  md:w-1/2   md:text-left">
        ...
        {/* Hero Image */}
        <div className="w-full md:w-1/2  h-[500px] flex justify-center">
          <Image
            src={heroImg}
            alt="Interior Door"
